...
const TOOLS = Object.freeze([
  ...
  tool(PPT_IMPROVE_CAPABILITY, "create_ppt_improve_job", "Create a report-bound, copy-on-write PPTX improvement job.", objectInput({ input: STRING, report: STRING, output: STRING, profile: Object.freeze({ type: "string", enum: ["safe-package", "audit-only"] }), idempotencyKey: STRING }, ["input", "report", "output"]), JOB_SCHEMA, annotations(false, false, false)),
