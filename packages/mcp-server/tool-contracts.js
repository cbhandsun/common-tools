...
const TOOLS = Object.freeze([
  ...
  tool(PROJECT_AUDIT_CAPABILITY, "create_project_audit_job", "Create a read-only, evidence-based local project audit job for an explicit audit level and scope.", objectInput({ projectRoot: STRING, output: STRING, level: Object.freeze({ type: "string", enum: ["1", "2", "3", "quick", "standard", "deep", "fast", "normal", "regular", "comprehensive", "快速审计", "标准审计", "深度审计", "快速", "标准", "深度"], description: "Audit depth; accepts numbered choices, English IDs/aliases, or Chinese names; defaults to standard." }), scope: Object.freeze({ ...STRING, description: "Required. 1/全部四域 for all domains, or comma-separated Chinese/English choices 2 to 5 / scope IDs." }), idempotencyKey: STRING }, ["output", "scope"]), JOB_SCHEMA, annotations(false, false, false)),
