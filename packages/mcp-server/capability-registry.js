...
const CREATE_TOOL_HANDLERS = Object.freeze({
  create_editable_job: Object.freeze({
    capability: EDITABLE_REGISTRATION.capability,
...
function readLocalJob(name, args, context) {
  ...
  if (["get_job", "cancel_job", "list_job_artifacts"].includes(name) && currentJob.capability !== EDITABLE_REGISTRATION.capability) throw new Error("job belongs to a different capability");
...
module.exports = { LOCAL_REGISTRATIONS, createLocalJob, readLocalJob };
