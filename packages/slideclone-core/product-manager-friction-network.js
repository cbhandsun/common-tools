...
function createProductManagerFrictionNetworkObjects(images = [], textBoxes = [], slideSize = DEFAULT_SLIDE, _options = {}) {
...
function normalizeProductManagerFrictionNarrativeTextBoxes(textBoxes, _slideSize = DEFAULT_SLIDE) {
