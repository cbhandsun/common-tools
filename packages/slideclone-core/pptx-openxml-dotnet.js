...
const { expandRestrictedSvgGraphics } = require("./restricted-svg");
const { createOpenXmlBuildCacheIdentity, readOpenXmlBuildCache, writeOpenXmlBuildCache } = require("./openxml-build-cache");
