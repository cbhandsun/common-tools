...
function classifyChartProfile({ layerType, detector, reason, item, page: _page }) {
...
function compactStructureSignature(signature = {}) {
  ...
  if (Array.isArray(signature.evidence)) compact.evidence = signature.evidence.slice(0, 8);
