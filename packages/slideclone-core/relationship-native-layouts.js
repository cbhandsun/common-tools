"use strict";
const { validBox, boxCenter, clusterByCoordinate, boxArea, intersectionArea, median, safeColor, containsBox, spread, normalizeDegrees } = require("./relationship-native-geometry");
const { branchCardNodeShape, branchCardCurveShape, measuredGenericNodeShape, measuredGenericConnectorShape, sankeyNodeShape, sankeyBandShape, vennEllipseShape, vennSupplementaryShape, concentricLayerShape, quadrantPanelShape, quadrantAxisShape, comparisonCellShape, comparisonGridLineShape, timelineAxisShape, timelineMilestoneShape, hubSpokeNodeShape, hubSpokeConnectorShape, topologyNodeShape, topologyConnectorShape, funnelLensNodeShape, funnelLensConnectorShape, funnelLensFocusShapes, swimlaneNodeShape, swimlaneConnectorShape, layeredStackShape, cycleLoopSegmentShapes, fishboneNodeShape, fishboneSpineShape, fishboneBranchShape, flowNodeShape, flowConnectorShape, treeNodeShape, treeConnectorShape } = require("./relationship-native-shapes");
const { measureBranchCurvesFromAnchors } = require("./pixel-branch-curve-detector");
const { topologyNodes, augmentTopologyAxisConnectors, nearestTopologyNode, distancePointToBox, measuredTopologyConnector, isIgnorableTopologyLineFragment, isTopologyCompositeAggregate, topologyConnectorEndpoints, distancePointToSegment, pointInsideBox, isConnectedTopology, isSafeTopologyLayout } = require("./relationship-topology-helpers");
