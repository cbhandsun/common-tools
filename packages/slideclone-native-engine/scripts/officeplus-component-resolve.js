...
async function main() {
  ...
  process.stdout.write(`OfficePLUS component targets: ${report.summary.found}/${report.summary.targets}\n`);
  process.stdout.write(`direct downloads: ${report.summary.directDownload}\n`);
  process.stdout.write(`auth required: ${report.summary.authRequired}\n`);
