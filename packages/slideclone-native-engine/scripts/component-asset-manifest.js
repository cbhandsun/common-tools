...
function main() {
  ...
  process.stdout.write(`component asset layers: ${manifest.summary.layers}` + "\n");
  process.stdout.write(`layersWithLocalAssets: ${manifest.summary.layersWithLocalAssets}` + "\n");
  process.stdout.write(`localAssetMatches: ${manifest.summary.localAssetMatches}` + "\n");
