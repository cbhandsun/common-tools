...
function main() {
  ...
  process.stdout.write(`replacement components: ${report.summary.components}\n`);
  process.stdout.write(`replacement elements: ${report.summary.elements}\n`);
...
if (require.main === module) {
  try {
    ...
    process.stderr.write(`${safeString(error?.message || error)}\n`);
    process.exitCode = 1;
  }
}
