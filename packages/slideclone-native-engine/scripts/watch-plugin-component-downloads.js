...
async function main() {
  ...
  process.stdout.write(`changed plugin component files: ${report.changedCount}\n`);
  for (const harvest of report.harvests) process.stdout.write(`- ${harvest.provider}: ${harvest.copiedCount}\n`);
