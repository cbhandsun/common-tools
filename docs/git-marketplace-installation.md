...
- Git ref: `v0.1.15` (reviewed immutable release)
...
```powershell
codex plugin marketplace add cbhandsun/common-tools --ref v0.1.15 --sparse .agents/plugins --sparse plugins/common-tools
```
