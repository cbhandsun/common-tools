...
- Git ref: `v0.1.18` (reviewed immutable release)
...
```powershell
codex plugin marketplace add cbhandsun/common-tools --ref v0.1.18 --sparse .agents/plugins --sparse plugins/common-tools
```
