...
- Git ref: `v0.1.19` (reviewed immutable release)
...
```powershell
codex plugin marketplace add cbhandsun/common-tools --ref v0.1.19 --sparse .agents/plugins --sparse plugins/common-tools
```
