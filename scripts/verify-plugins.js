...
function assertUnifiedGitMarketplace(root, _capabilities) {
  ...
  if (!versionAtLeast(pluginRuntimeVersion(metadata.version), "0.1.9")) throw new Error("unified Codex plugin version does not include the ppt-create composition release");
