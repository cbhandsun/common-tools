...
function assertUnifiedGitMarketplace(root, _capabilities) {
  ...
  if (!versionAtLeast(pluginRuntimeVersion(metadata.version), "0.1.11")) throw new Error("unified Codex plugin version does not include the current ppt-create release");
