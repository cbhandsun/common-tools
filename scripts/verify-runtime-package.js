...
const IMAGE_EDITABLE_RELEASE_FILES = Object.freeze([
  "packages/slideclone-core/asset-closure-funnel.js",
  "packages/slideclone-core/cli-scaffold-generator.js",
  "packages/slideclone-core/component-rebuild-precedence.js",
  "packages/slideclone-core/component-template-group-matcher.js",
  "packages/slideclone-core/component-template-style.js",
  "packages/slideclone-core/connector-component-library.js",
  "packages/slideclone-core/dense-radial-network-policy.js",
  "packages/slideclone-core/dense-topology-line-compactor.js",
  "packages/slideclone-core/embedded-expert-screenshot.js",
  "packages/slideclone-core/fidelity-crop-materializer.js",
  "packages/slideclone-core/fragmented-asset-chain.js",
  "packages/slideclone-core/network-rebuild-orchestrator.js",
  "packages/slideclone-core/ocr-grid-table.js",
  ...
  "packages/slideclone-core/prototype-generation-loop.js",
  "packages/slideclone-core/prototype-loop-measurement.js",
  "packages/slideclone-core/prototype-validation-screenshot-policy.js",
  "packages/slideclone-core/radial-network-detector.js",
  "packages/slideclone-core/residual-overlap-policy.js",
  "packages/slideclone-core/residual-ownership.js",
  "packages/slideclone-core/runtime-engine-hybrid.js",
  "packages/slideclone-core/smart-review-hybrid.js",
  "packages/slideclone-core/stacked-layer-color-sampling.js",
  "packages/slideclone-core/system-map-pixel-evidence.js",
  "packages/slideclone-core/system-map-reconstruction.js",
  "packages/slideclone-core/system-map-semantics.js",
  "packages/slideclone-core/text-anchored-process-network.js",
  "packages/slideclone-core/text-box-micro-adjust.js",
  "packages/slideclone-core/triangle-topology-measurement.js",
  "packages/slideclone-core/value-transformation-table.js",
  "packages/slideclone-core/visual-feature-context.js",
  "packages/slideclone-core/visual-operation-sync.js",
  "packages/slideclone-core/workflow-collaboration-multiplier-scope.js",
  "packages/slideclone-core/cover-graphic-rules.js",
  "packages/slideclone-core/registry-graphic-rules.js",
  "packages/slideclone-core/graphic-crop-materializer.js",
  "packages/slideclone-core/workflow-cover-text.js",
  "packages/slideclone-core/python/inpaint-decorative-background.py",
  "packages/slideclone-core/decorative-cover-graphics.js",
  "packages/slideclone-core/graphic-crop-analysis.js",
  "packages/slideclone-core/graphic-crop-generation.js",
  "packages/slideclone-core/entropy-challenge-crops.js",
  "packages/slideclone-core/graphic-underlay-crops.js",
  "packages/slideclone-core/kpi-title-graphics.js",
  "packages/slideclone-core/page-output-rules.js",
  "packages/slideclone-core/font-evidence.js",
  "packages/slideclone-core/page-text-rule-helpers.js",
  "packages/slideclone-core/page-text-rules.js",
  "packages/slideclone-core/comparison-matrix-text.js",
  "packages/slideclone-core/comparison-matrix-layout.js",
  "packages/slideclone-core/structured-case-matrix-reconstruction.js",
  "packages/slideclone-core/comparison-matrix-reconstruction.js",
  "packages/slideclone-core/structured-card-visual-reconstruction.js",
  "packages/slideclone-core/relationship-native-shell.js",
  ...
  "packages/slideclone-core/visual-atom-topology.js",
  "packages/slideclone-core/visual-atom-native-shapes.js",
  "packages/slideclone-core/visual-atom-fallback.js",
  "packages/slideclone-core/visual-atom-native-metadata.js",
  "packages/slideclone-core/gantt-native-shell.js",
  "packages/slideclone-core/visual-atom-promotion.js",
  "packages/slideclone-core/visual-atom-native-policy.js",
  "packages/slideclone-core/visual-atom-component-grouping.js",
  "packages/slideclone-core/asset-hub-cycle-reconstruction.js",
  "packages/slideclone-core/asset-os-closed-loop-reconstruction.js",
  "packages/slideclone-core/comparison-matrix-evidence.js",
  "packages/slideclone-core/closed-loop-hybrid.js",
  "packages/slideclone-core/text-mask-cleanup.js",
  "packages/slideclone-core/four-step-landing-reconstruction.js",
  "packages/slideclone-core/diagram-label-matching.js",
  "packages/slideclone-core/wms-route-reconstruction.js",
  "packages/slideclone-core/workflow-wms-route-chain-scope.js",
  "packages/slideclone-core/detection-result.js",
  "packages/slideclone-core/diagram-archetypes.js",
  "packages/slideclone-core/diagram-component-strategy.js",
  "packages/slideclone-core/diagram-constants.js",
  "packages/slideclone-core/diagram-geometry.js",
  "packages/slideclone-core/diagram-metrics.js",
  "packages/slideclone-core/diagram-residual-analysis.js",
  "packages/slideclone-core/diagram-structure-signature.js",
  "packages/slideclone-core/diagram-understanding-entry.js",
  "packages/slideclone-core/diagram-understanding.js",
  "packages/slideclone-core/diagram-visual-topology.js",
  "packages/slideclone-core/fishbone-visual-atoms.js",
  "packages/slideclone-core/layer-classifier.js",
  "packages/slideclone-core/pixel-concentric-detector.js",
  "packages/slideclone-core/pixel-venn-detector.js",
  "packages/slideclone-core/semantic-matrix-grid.js",
  "packages/slideclone-core/visual-atom-components.js",
  "packages/slideclone-core/visual-atom-constants.js",
  "packages/slideclone-core/visual-atom-dense-nodes.js",
  "packages/slideclone-core/visual-atom-extractor.js",
  "packages/slideclone-core/visual-atom-line-components.js",
  "packages/slideclone-core/visual-atom-semantic-components.js",
  "packages/slideclone-core/visual-atom-shape-recognition.js",
  "packages/slideclone-core/visual-atom-utils.js",
  "packages/slideclone-core/visual-atoms.js",
  "packages/slideclone-core/visual-concentric-circles.js",
  "packages/slideclone-core/visual-grid-cells.js",
  "packages/slideclone-core/visual-pie-segments.js",
  "packages/slideclone-core/visual-quadrant-panels.js",
  "packages/slideclone-core/visual-sankey-bands.js",
  ...
  "packages/slideclone-core/raster-native-detection.js",
  "packages/slideclone-core/structured-residual-splitting.js",
  "packages/slideclone-core/residual-component-analysis.js",
  "packages/slideclone-core/residual-primitive-erasure.js",
  "packages/slideclone-core/reconstruction-contract.js",
  "packages/slideclone-core/reconstruction-quality-budget.js",
    "packages/slideclone-core/deck-ir-structure.js",
    "packages/slideclone-core/deck-ir-tree.js",
    "packages/slideclone-core/deck-ir-admission.js",
    "packages/slideclone-core/archive-admission.js",
    "packages/slideclone-core/structured-source-images.js",
    "packages/slideclone-core/native-rebuilder-registry.js",
    "packages/slideclone-core/horizontal-step-chain.js",
    "packages/slideclone-core/hierarchy-diagram.js",
    "packages/slideclone-core/triangle-topology.js",
    "packages/slideclone-core/cover-engine-core.js",
    "packages/slideclone-core/dense-radial-network-shapes.js",
    "packages/slideclone-core/network-native-shapes.js",
    "packages/slideclone-core/normalized-pages-admission.js",
    "packages/slideclone-core/reconstruction-contract-validation.js",
    "packages/slideclone-core/deck-template-context.js",
    "packages/slideclone-core/template-build-admission.js",
    "packages/slideclone-core/delivery-artifacts.js",
    "packages/slideclone-core/diagram-residual-crops.js",
    "packages/slideclone-core/residual-splitting.js",
    "packages/slideclone-core/workflow-shape-primitives.js",
    "packages/slideclone-core/prd-generation-shapes.js",
    "packages/slideclone-core/prototype-validation-shapes.js",
    "packages/slideclone-core/demand-understanding-shapes.js",
    "packages/slideclone-core/page-native-graphics-stage.js",
    "packages/slideclone-core/page-hybrid-graphics-stage.js",
    "packages/slideclone-core/native-output-sanitizer.js",
    "packages/slideclone-core/prd-auto-generation-narrative.js",
  ...
  "packages/remote-mcp-server/redis-connection.js",
  ...
  "packages/slideclone-core/native-rebuild-profile.js",
  ...
  "packages/slideclone-core/page-progress-lifecycle.js",
  "packages/slideclone-core/page-graphics-stage.js",
  ...
  "packages/slideclone-core/slide-size.js",
  "packages/slideclone-core/png.js",
  "packages/slideclone-core/pptx-openxml-dotnet.js",
  "packages/slideclone-core/pptx-build-execution.js",
  "packages/slideclone-core/pptx-build-mode.js",
  ...
  "packages/slideclone-core/native-chart-shell-shapes.js",
  ...
  "packages/slideclone-core/libreoffice-tools.js",
  "packages/slideclone-core/diff-pixel-png.js",
  "packages/slideclone-core/pixel-diff-page-worker.js",
  "packages/slideclone-core/edge-background-alpha.js",
  "packages/slideclone-core/icon-crop-refiner.js",
  "packages/slideclone-core/knowledge-graph-icon-crops.js",
  "packages/slideclone-core/full-slide-native-residual.js",
  "packages/slideclone-core/arc-residual-masks.js",
  "packages/slideclone-core/semantic-arc-admission.js",
  "packages/slideclone-core/source-border-fit.js",
  "packages/slideclone-core/source-horizontal-connector-fit.js",
  "packages/slideclone-core/knowledge-graph-gray-node-fit.js",
  "packages/slideclone-core/gray-border-pixels.js",
  "packages/slideclone-core/gray-border-residual.js",
  "packages/slideclone-core/text-ink-geometry.js",
  "packages/slideclone-core/measured-text-fit.js",
  "packages/slideclone-core/text-refinement-coordinator.js",
  "packages/slideclone-core/knowledge-graph-relation-fit.js",
  "packages/slideclone-core/residual-publication.js",
  "packages/slideclone-core/page-reuse.js",
  "packages/slideclone-core/diagram-text-candidates.js",
  "packages/slideclone-core/graphic-crop-policy.js",
  "packages/slideclone-core/page-selection.js",
  ...
  "packages/team-runtime/job-row-reader.js",
...
const PPT_CREATE_RELEASE_FILES = Object.freeze([
  ...
  "packages/ppt-create-core/editable-data-validation.js",
  "packages/ppt-create-core/ir-editor-client.js",
  "packages/ppt-create-core/ir-editor-session.js",
  ...
  "packages/ppt-create-core/semantic-components.js",
...
const REQUIRED_FILES = Object.freeze([
  ...
  "packages/team-runtime/job-input.js",
    "packages/team-runtime/job-row-state.js",
...
function imageEditableEnhancementProbe() {
  return [
    ...
    "const checks=[['capability-version',versionReady],['native-export',typeof native.residualEraseObjects==='function'],['production-profile',profile.PRODUCTION_PROFILE_NAME==='local-production-parity-v1'&&profile.createProductionNativeRebuildOptions().vectorizeStatusIcons===false],['worker-export',typeof worker.residualDeduplicationStatus==='function'],['source-archive-export',typeof archive.createEditableSourceArchive==='function'&&archive.MAX_RAW_IMAGE_ARCHIVE_PAGES===20],['document-normalizer-export',typeof documentNormalizer.createTeamDocumentNormalizer==='function'&&documentNormalizer.MAX_DOCUMENT_PAGES===20],['batch-quality-export',typeof quality.createRawImageRenderQualityVerifier==='function'],['local-batch-core',localCoreSource.includes('MAX_EDITABLE_BATCH_INPUTS')&&localCoreSource.includes('inputPaths')&&localCoreSource.includes('EDITABLE_DOCUMENT_EXTENSIONS')],['local-batch-cli',cliSource.includes('editable batch')&&cliSource.includes('editable-source-archive')&&cliSource.includes('--inputs')],['local-batch-skill',localSkill.includes('common-tools editable batch')&&localSkill.includes('normalize.maxPages')&&localSkill.includes('200,000,000 decoded pixels')],['residual-export',typeof residual.eraseObjectMask==='function'],['remote-worker-wiring',remoteSource.includes('createNativeRebuilder')&&remoteSource.includes('createTeamDocumentNormalizer')&&remoteSource.includes('full-slide-native-residual')&&remoteSource.includes('preserveLocalFidelityImages: true')],['native-strategy',nativeSource.includes('full-slide-object-erased-residual')],['worker-quality-gate',workerSource.includes('residual-native-duplicates-removed')&&workerSource.includes('local-production-profile-aligned')],['source-worker-contract',workerSource.includes('raw-image-batch-validated')&&workerSource.includes('document-pages-normalized')&&workerSource.includes('admitNormalizedPages')&&archiveAdmission.MAX_RAW_IMAGE_PAGES===20&&typeof archiveAdmission.createArchiveAdmission==='function'&&oversizedPagesRejected],['marketplace-skill-gate',skill.includes('residual-native-duplicates-removed')&&skill.includes('local-production-profile-aligned')&&skill.includes('raw-image-batch-validated')&&skill.includes('document-pages-normalized')]];",
...
function pptCreateLayoutProbe() {
  return [
    ...
    "const version=String(manifest.version||'').split('.').map(Number);",
    "stage='registry-load';const themes=require(path.join(root,'packages','ppt-create-core','theme-registry.js'));const layouts=require(path.join(root,'packages','ppt-create-core','layout-registry.js'));const models=require(path.join(root,'packages','ppt-create-core','data-models.js'));const semantic=require(path.join(root,'packages','ppt-create-core','semantic-components.js'));const editor=require(path.join(root,'packages','ppt-create-core','editor.js'));const exporter=require(path.join(root,'packages','ppt-create-core','export.js'));const pdf=require(path.join(root,'packages','ppt-create-core','libreoffice-pdf.js'));const briefPlanner=require(path.join(root,'packages','ppt-create-core','planner.js'));const layoutPlanner=require(path.join(root,'packages','ppt-create-core','layout.js'));const briefSchema=require(path.join(root,'packages','ppt-create-core','presentation-brief.schema.json'));const schema=require(path.join(root,'packages','ppt-create-core','presentation-spec.schema.json'));",
    ...
    "stage='semantic-component';const component=semantic.planSemanticAnalysis({kind:'analysis',model:'funnel',entries:[{id:'top'},{id:'bottom'}]},{x:0,y:0,w:400,h:200});",
...
function pptCreateEnhancementProbe() {
  return [
    ...
    "const checks=[['capability-version',versionReady],['asset-provenance',assetManifest.length===1&&assetManifest[0].source.kind==='customer-provided'],['image-delivery',typeof delivery.createImageDeliveryArtifacts==='function'&&typeof delivery.createPreservationPlan==='function'],['ir-editor',typeof irEditor.applyAndExportIrArtifacts==='function'&&typeof irEditor.applyIrEditorPatch==='function'&&typeof irEditor.createIrPreviewHtml==='function'&&typeof irEditor.exportEditedIrArtifacts==='function'&&irEditorSource.includes('edit-finalization-report.json')&&irEditorSource.includes('set-table-cell')&&irEditorSource.includes('set-chart-data')&&irEditorSource.includes('realpathSync.native')],['ir-editor-session',typeof irSession.startIrEditorSession==='function'],['ir-lifecycle',typeof irLifecycle.applyObjectLifecycleOperation==='function'],['ir-page-lifecycle',typeof irPageLifecycle.applyPageLifecycleOperation==='function'],['document-ingest',brief.deckVariantCount===2&&brief.sections.length===1&&typeof pdfText.extractPdfLayout==='function'&&typeof pdfText.extractPdfText==='function'],['prompt-compose',typeof prompt.promptToPresentation==='function'&&typeof prompt.promptToPresentationAsync==='function'&&typeof prompt.persistPromptPlan==='function'&&typeof prompt.persistPromptPlanAsync==='function'&&typeof prompt.validateGenerationManifest==='function'],['content-provider',typeof contentProvider.ContentProviderError==='function'&&contentProvider.MAX_PROVIDER_REQUEST_BYTES===262144&&typeof contentProvider.ContentProviderRegistry==='function'&&typeof contentProvider.createHttpsJsonContentProvider==='function'&&typeof contentProviderConfig.loadContentProviderConfig==='function'&&providerConfigSource.includes('realpathSync.native')],['semantic-depth',roadmap.component==='roadmap'&&gantt.component==='gantt'&&JSON.stringify(roadmap.nodes)!==JSON.stringify(gantt.nodes)],['template-safety',generatedTemplateRejected&&typeof template.inspectTemplate==='function'&&typeof template.applyTemplateLayoutMap==='function'],['deck-variants',deckVariants.length===2&&variantRecords.length===2],['citations-notes',notes.includes('Explain the verified point.')&&notes.includes('https://example.com/source')],['team-worker',typeof worker.createPptCreateHandler==='function'],['team-archive',typeof teamArchive.createPptCreateArchive==='function'&&typeof teamArchive.admitPptCreateArchive==='function'],['spec-schema',schema.properties&&schema.properties.deckVariantCount&&schema.properties.template&&schema.$defs&&schema.$defs.citation&&schema.$defs.slide.properties.speakerNotes],['brief-schema',briefSchema.properties&&briefSchema.properties.deckVariantCount],['openxml-template',admission.includes('ValidateTemplate')&&packageWriter.includes('ResolvePageLayout')],['openxml-notes',notesWriter.includes('class SpeakerNotesWriter')&&packageWriter.includes('SpeakerNotesWriter.Add')],['marketplace-skill',skill.includes('ppt edit-session')&&skill.includes('loopback-editor-session-bound')&&skill.includes('semantic-table-data-editable')&&skill.includes('semantic-chart-data-editable')&&skill.includes('ppt draft')&&skill.includes('ppt compose')&&skill.includes('--provider-config')&&skill.includes('document-visual-structure-preserved')&&skill.includes('template-semantic-layout-mapped')&&skill.includes('complex-graphic-native-gate')&&skill.includes('ir-batch-style-validated')&&skill.includes('ir-object-lifecycle-validated')&&skill.includes('ir-page-lifecycle-validated')&&skill.includes('ppt archive')&&skill.includes('ppt apply-ir-edit')&&skill.includes('ppt finalize-ir-edit')&&skill.includes('ppt export-ir')&&skill.includes('edit-finalization-report.json')&&skill.includes('CONTENT_PROVIDER_*')&&skill.includes('deck.variants.json')&&skill.includes('asset-manifest.json')&&skill.includes('generation-manifest.json')&&skill.includes('asset-license-policy-compliant')&&skill.includes('template-layout-capacity-respected')]];",
    "const failed=checks.find((entry)=>!entry[1]);if(failed){process.stdout.write(failed[0]);process.exit(2);}process.stdout.write('ready');",
    "}catch{process.stdout.write(stage);process.exit(2);}"
  ].join("");
}
