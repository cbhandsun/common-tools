...
test("workspace packages declare direct sibling dependencies without a team-runtime cycle", () => {
  const required = {
    ...
    "ppt-create-core": ["@common-tools/archive-core", "@common-tools/capability-contracts", "@common-tools/capability-runtime", "@common-tools/ppt-quality-core"],
    "slideclone-core": ["@common-tools/archive-core", "@common-tools/capability-contracts", "@common-tools/capability-runtime", "@common-tools/ppt-quality-core", "@common-tools/project-audit-core", "@common-tools/team-runtime"],
