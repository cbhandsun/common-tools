...
test("runtime package release gate retains and functionally probes the complete ppt-create enhancement set", () => {
  ...
  for (const marker of ["asset-provenance", "createImageDeliveryArtifacts", "applyIrEditorPatch", "extractMarkdownOutline", "promptToPresentation", "persistPromptPlan", "applyTemplateLayoutMap", "extractPdfText", "generatedTemplateRejected", "createDeckVariants", "describeVariants", "composeSpeakerNotes", "createPptCreateHandler", "createPptCreateArchive", "admitPptCreateArchive", "deckVariantCount", "ValidateTemplate", "SpeakerNotesWriter.Add", "ppt draft", "ppt compose", "document-visual-structure-preserved", "template-semantic-layout-mapped", "complex-graphic-native-gate", "ir-batch-style-validated", "ppt archive", "ppt apply-ir-edit", "deck.variants.json", "asset-manifest.json"]) assert.match(probe, new RegExp(marker.replaceAll(".", "\\.")));
});
