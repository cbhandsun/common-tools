...
test("runtime package release gate retains and functionally probes the complete ppt-create enhancement set", () => {
  ...
  for (const marker of ["asset-provenance", "createImageDeliveryArtifacts", "applyAndExportIrArtifacts", "applyIrEditorPatch", "applyObjectLifecycleOperation", "applyPageLifecycleOperation", "exportEditedIrArtifacts", "extractMarkdownOutline", "promptToPresentation", "promptToPresentationAsync", "ContentProviderRegistry", "createHttpsJsonContentProvider", "loadContentProviderConfig", "persistPromptPlan", "persistPromptPlanAsync", "semantic-depth", "validateGenerationManifest", "applyTemplateLayoutMap", "extractPdfText", "extractPdfLayout", "generatedTemplateRejected", "createDeckVariants", "describeVariants", "composeSpeakerNotes", "createPptCreateHandler", "createPptCreateArchive", "admitPptCreateArchive", "deckVariantCount", "ValidateTemplate", "SpeakerNotesWriter.Add", "ppt draft", "ppt compose", "--provider-config", "document-visual-structure-preserved", "template-semantic-layout-mapped", "template-layout-capacity-respected", "complex-graphic-native-gate", "ir-batch-style-validated", "ir-object-lifecycle-validated", "ir-page-lifecycle-validated", "ppt archive", "ppt apply-ir-edit", "ppt finalize-ir-edit", "ppt export-ir", "deck.variants.json", "asset-manifest.json", "generation-manifest.json", "asset-license-policy-compliant"]) assert.match(probe, new RegExp(marker.replaceAll(".", "\\.")));
});
